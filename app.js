...
function tasksRender(list) {
    ...
    list.forEach((task) => {
        ...
        <label class="todo_checkbox">
            ...
            class="todo_checkbox-div"></div>
        </label>
        <div class="todo_task-text">${task.text}</div>
        <div class="todo_task-del"><i class="fa-solid fa-trash"></i></div>
        </div>
        `
        htmlList = htmlList + taskHtaml
    })
